...
/*       var someOtherVariable = 171;
        ...
        int third = first;
        first = 65;
        // first = 55; pořadí je důležité v Javě (? To asi ne. Spíše lze definovat proměnné pouze v rámci jedné metody? - ověřit si to - it's called variable scope). příklad je tento řádek či řádek č.20. Switch those lines and see the result. third would have been 50, not 55.
